...
_C.BBOX.VIS_PRED = "no"
_C.BBOX.TRESH = 0.8
_C.BBOX.MIN_SIZE_HEIGTH = 30
_C.BBOX.MIN_SIZE_WIDTH = 10
...
_C.DENSEPOSE = CN()
_C.DENSEPOSE.PATH_PROCESS = 'raw'
_C.DENSEPOSE.ONLY_ONE = 'no'
_C.DENSEPOSE.SAVE_RGB = 'yes'
_C.DENSEPOSE.SAVE_BLACK = 'no'
_C.DENSEPOSE.SAVE_GREEN = 'no'
_C.DENSEPOSE.TRESH = 0.1
